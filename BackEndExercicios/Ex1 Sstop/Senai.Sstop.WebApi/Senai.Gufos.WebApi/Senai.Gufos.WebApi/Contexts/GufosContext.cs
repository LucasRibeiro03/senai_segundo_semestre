...
namespace Senai.Gufos.WebApi.Domains
{
    public partial class GufosContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.Presenças'. Please see the warning messages.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categorias>(entity =>
            {
                ...
                entity.HasIndex(e => e.Nome)
                    .HasName("UQ__Categori__7D8FE3B2D817C873")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D10534057735BE")
                    .IsUnique();
